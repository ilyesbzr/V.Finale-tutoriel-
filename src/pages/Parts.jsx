...
export default function Parts() {
  ...
  const [activeTab, setActiveTab] = useState('overview'); // 'overview', 'detail', 'margin'
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip formatter={(value) => [`${formatNumber(value)}€`, 'CA']} />
                      <Bar dataKey="value" radius={[4, 4, 0, 0]}>
                        <LabelList 
                          dataKey="value"
                          position="top"
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {detailData.map((item, index) => (
                      <tr key={item.family} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap text-base text-center font-medium text-gray-900">
                          {item.family}
                        </td>
          ...
          <Card>
            <div className="px-4 py-3 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Évolution par famille de pièces</h3>
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <XAxis dataKey="name" />
                      <YAxis tickFormatter={(value) => `${value/1000}K`} />
                      <Tooltip formatter={(value) => [`${formatNumber(value)}€`, 'Marge']} />
