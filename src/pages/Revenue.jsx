...
export default function Revenue() {
  ...
  const [clientTypeView, setClientTypeView] = useState('service'); // 'service' ou 'clientType'
  const [viewType, setViewType] = useState('canet'); // Pour l'onglet Avancement
  const [comparatifsViewType, setComparatifsViewType] = useState('caapv'); // Pour l'onglet Comparatifs
  ...
  const [chartType, setChartType] = useState('bar'); // 'bar' ou 'monthly'
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    {chartType === 'bar' ? (
                      ...
                      >
                        ...
                        />
                        <Tooltip 
                          formatter={(value, name) => [`${formatNumber(value * (comparatifsViewType === 'caapv' ? 0.7 : 0.8))}K€`, name]}
                        />
                        <Legend />
                        <Bar dataKey={selectedYear - 2} name={selectedYear - 2} fill={comparatifsViewType === 'caapv' ? "#1e3a8a" : "#7c2d92"} barSize={60}>
                          <LabelList
                            ...
                            position="top"
                            formatter={(value) => `${formatNumber(value * (comparatifsViewType === 'caapv' ? 0.7 : 0.8))}K€`}
                      ...
                      >
                        ...
                        />
                        <Tooltip 
                          formatter={(value, name) => [`${formatNumber(value)}K€`, name]}
