...
export default function Rent(): JSX.Element {
  ...
  const [caClientLoisirData, setCaClientLoisirData] = useState<CAClientLoisirData>({
    2023: {
  ...
  const handleValueChange = (year: number, monthKey: string, value: string): void => {
  ...
  const getCurrentMonthRentData = (): ChartDataItem[] => {
    const currentDate = new Date();
  ...
  const getCurrentMonthFraisData = (): ChartDataItem[] => {
    const currentDate = new Date();
    const currentMonth = currentDate.toLocaleString('fr-FR', { month: 'long' });
    const currentYear = currentDate.getFullYear();
    const previousYear = currentYear - 1;
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Tooltip 
                      formatter={(value: number) => [`${formatNumber(value)}€`, 'CA Rent']}
                      contentStyle={{
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Tooltip 
                      formatter={(value: number) => [`${value}€`, 'Frais']}
                      contentStyle={{
                        backgroundColor: 'white',
                        border: '1px solid #e5e7eb',
                        borderRadius: '8px'
