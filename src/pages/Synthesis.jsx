...
function Synthesis() {
  ...
  const [dailyViewType, setDailyViewType] = useState('capr'); // 'capr', 'prcomptoir', 'accessoires'
  const [showHEC, setShowHEC] = useState(false); // Toggle between HT and HEC view
  const [activeTab, setActiveTab] = useState('overview'); // 'overview', 'financial'
  const [emailReportData, setEmailReportData] = useState(null);
  const [showEmailReportModal, setShowEmailReportModal] = useState(false);
  const [viewType, setViewType] = useState('canet'); // 'canet' or 'hours'
        ...
        <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
                ...
                <div className="relative">
                  <MetricCard
                    ...
                    triggerRef={el => triggerRefs.current['totalRevenue'] = el}
                ...
                <div className="relative">
                  <MetricCard
                    ...
                    monthProgress={monthProgress}
                    popupId="caApv"
                    triggerRef={el => triggerRefs.current['caApv'] = el}
                    onMouseEnter={setHoveredMetric}
                    onMouseLeave={() => setHoveredMetric(null)}
                    hoveredMetric={hoveredMetric}
                    metricId="caApv"
                ...
                <div className="relative">
                  <MetricCard
                    ...
                    monthProgress={monthProgress}
                    popupId="hours"
                    triggerRef={el => triggerRefs.current['hours'] = el}
                    onMouseEnter={setHoveredMetric}
                    onMouseLeave={() => setHoveredMetric(null)}
                    hoveredMetric={hoveredMetric}
                    metricId="hours"
          ...
          <div className="mt-20">
            ...
            <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-900">{t('synthesis.serviceDetails')}</h3>
