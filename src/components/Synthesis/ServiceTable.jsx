      ...
      <div className="overflow-x-auto -mx-4 sm:mx-0">
        <div className="inline-block min-w-full align-middle">
          <table className="table-modern min-w-full">
            <thead>
              <tr>
                <th className="px-6 py-4 text-left text-lg font-bold uppercase tracking-wider w-1/5 bg-gray-100">
                  <span className="text-base">{t('synthesis.service')}</span>
                </th>
                <th className="px-6 py-4 text-center text-lg font-bold uppercase tracking-wider w-1/5 bg-gray-100">
