          ...
          <td className="px-6 py-4 whitespace-nowrap text-center relative">
            ...
            {activePopup === popupId && (
              <div 
                ...
                className="absolute bg-white border border-gray-200 shadow-2xl rounded-xl p-0 w-96 text-xl z-50"
                style={{
                  position: 'fixed',
                  top: '50%',
                  left: '50%',
  ...
  const getTotalRow = () => {
    ...
    return (
      <tr className="bg-gray-50 font-medium">
        <td className="px-6 py-4 whitespace-nowrap text-xl font-medium text-gray-900 flex items-center">
          ...
          <table className="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            <thead>
              <tr className="bg-gray-50">
                <th className="px-6 py-4 text-left text-xl font-bold uppercase tracking-wider w-1/5 bg-gray-50">
                  <span className="text-base">{t('synthesis.service')}</span>
                </th>
                <th className="px-6 py-4 text-center text-xl font-bold uppercase tracking-wider w-1/5 bg-gray-50">
