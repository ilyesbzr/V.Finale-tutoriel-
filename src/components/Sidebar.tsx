        ...
        <div className="flex flex-col h-0 flex-1 sidebar-modern">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 space-y-1">
              ...
              >
                <AdjustmentsHorizontalIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                ...
                >
                  <PresentationChartLineIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                  Synthèse
                </Link>
              ...
              >
                <ChartBarIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
              ...
              >
                <ClockIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                {t('navigation.hours')}
              </Link>
              ...
              >
                <ShoppingCartIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
              ...
              >
                <ChartPieIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                Rentabilité
              </Link>
              ...
              >
                <DocumentCheckIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
              ...
              >
                <ClipboardDocumentCheckIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
              ...
              >
                <WrenchScrewdriverIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                Pièces
              </Link>
              ...
              >
                <TruckIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                Rent
              </Link>
              ...
              >
                <HandRaisedIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                Gestes commerciaux
              </Link>
            </nav>
            ...
            <div className="mt-auto px-2 space-y-1 border-t border-blue-800 pt-4">
              ...
              >
                <FilmIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
              ...
              >
                <QuestionMarkCircleIcon className="mr-4 h-8 w-8 transition-transform duration-200 group-hover:scale-110" />
                {t('navigation.help')}
              </Link>
            </div>
