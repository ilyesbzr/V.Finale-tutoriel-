...
import { DepartmentSales, SalesItem } from '../../types';
...
export default function SalesCard({ title, data, staffCount = 1 }: SalesCardProps): JSX.Element {
  ...
  const salesItems: SalesItemData[] = [
