...
+}
+
+export default function MobileSidebar({ isOpen, onClose }: MobileSidebarProps): JSX.Element | null {
...
+  const isActive = (path: string): string => location.pathname === path ? 'bg-blue-900 text-white' : 'text-blue-100 hover:bg-blue-800 hover:text-white';
