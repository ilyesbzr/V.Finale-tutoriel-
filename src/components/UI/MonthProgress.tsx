...
export default function MonthProgress({ date }: MonthProgressProps): JSX.Element {
  ...
  // Rendu du composant
  return (
    <div className="card-modern px-6 py-4 text-md w-full sm:min-w-[360px]">
      <div className="flex flex-col sm:flex-row sm:justify-center sm:items-center">
        {/* Affichage de la date d'analyse - centré */}
        <div className="text-gray-900 mb-2 sm:mb-0 text-lg text-center w-full font-semibold">
      ...
      <div className="mt-3 text-gray-700 text-md flex justify-between items-center font-medium">
        ...
        <span className="text-sm text-blue-700 font-semibold bg-gradient-to-r from-blue-50 to-blue-100 px-3 py-1 rounded-full border border-blue-200 shadow-sm ml-4">
